...
if exists fk_employees_aid;

alter table employees drop constraint
if exists fk_employees_department_id;
drop index
if exists ix_employees_department_id;

alter table project_employees drop constraint
if exists fk_project_employees_project;
drop index
if exists ix_project_employees_project;

alter table project_employees drop constraint
if exists fk_project_employees_employees;
drop index
if exists ix_project_employees_employees;
