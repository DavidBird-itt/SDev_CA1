...
"""),_display_(/*4.2*/main("Login", emps)/*4.21*/ {_display_(Seq[Any](format.raw/*4.23*/("""
    ...
    """),_display_(/*22.6*/helper/*22.12*/.form(action = controllers.routes.LoginController.loginSubmit())/*22.76*/ {_display_(Seq[Any](format.raw/*22.78*/("""
        ...
        """),format.raw/*26.9*/("""<div class="form-group">
            """),_display_(/*27.14*/inputText(loginForm("empId"), '_label -> "",
            'class -> "form-control input-xs", 'placeholder -> "Employee number")),format.raw/*28.82*/("""
        """),format.raw/*29.9*/("""</div>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Wed Mar 13 08:52:59 GMT 2019
                  SOURCE: /home/wdd/SDevProj/SDev_CA1/app/views/login.scala.html
                  HASH: d6829639d0f1503ede24ad81475318990ccb377e
                  MATRIX: 989->1|1129->70|1173->87|1200->89|1227->108|1266->110|1297->115|1372->165|1409->194|1448->196|1483->205|1554->250|1601->282|1640->284|1685->301|1744->329|1780->338|1820->348|1853->403|1885->409|1924->439|1964->441|2000->450|2074->497|2088->502|2122->515|2158->524|2200->536|2233->542|2300->583|2315->589|2388->653|2428->655|2465->692|2502->702|2515->706|2546->716|2583->726|2648->764|2795->890|2831->899|2911->952|3058->1078|3094->1087|3260->1223|3289->1241
