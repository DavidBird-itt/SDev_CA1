...
public class HomeController extends Controller {
    ...
    public Result employees() {
        ...
        return ok(employees.render(mList, wList, Employees.getEmployeeById(session().get("email"))));
    }
    ...
    public Result addWorker() {
        ...
        return ok(addWorker.render(employeeForm, Employees.getEmployeeById(session().get("email")) e);
        }
